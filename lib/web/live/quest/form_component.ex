defmodule Web.Live.Quest.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        <.input field={@form[:status]} type="select" label="Status" options={[:unstarted, :started, :finished]} />
        <.input field={@form[:start_time]} type="text" label="Start Time" />
        <.input field={@form[:finish_time]} type="text" label="Finish Time" />
        <:actions>
